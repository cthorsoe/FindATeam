...
export class UsersService {
   ...
   static getInitialUsersState() : UsersState{
    return { teamInvites: 0, loggedIn:{loggedIn: false, loggedInWithForm: false, userRole: "Guest"}, user: undefined, selectedUser: undefined, listedUsers:[], failedAutoLogin:false};
   }
